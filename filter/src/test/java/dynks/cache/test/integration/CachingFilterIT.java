...
import static dynks.cache.test.integration.Client.NOT_MODIFIED;
...
public class CachingFilterIT {
  ...
  public static final ServerPayloadCondition NON_EMPTY_CACHEABLE_PAYLOAD = new ServerPayloadCondition();
  ...
  @Test
  public void deleteRequestShouldBypassCache() throws IOException, URISyntaxException {
    ...
    assertThat(response)
            ...
            .hasEtag(NOT_SET)
            .hasResponseCode(OK)
            .is(NON_EMPTY_CACHEABLE_PAYLOAD)
            .isFor("api/v1/cached/deleteRequestShouldBypassCache");

  }

  @Test
  public void postRequestShouldBypassCache() throws IOException, URISyntaxException {
  ...
  @Test
  public void getOnCachedRegionShouldReturnEtag() throws IOException, URISyntaxException {
  ...
  @Test
  public void repeadedGetOnCachedRegionShouldReturnNonModified() throws IOException, URISyntaxException {
  ...
  @Test
  public void getToCachedResourceWithNonExistingEtagShouldReturnFreshValue() throws IOException, URISyntaxException {
  ...
  @Test
  public void repeatedGetOnCachedRegionFromDifferentClientsShouldReturnSameValue() throws IOException, URISyntaxException {
    //  when
